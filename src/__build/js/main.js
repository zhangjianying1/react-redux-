...
/******/ 	var hotCurrentHash = "79387161fe6b486daefb"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ExchangeCoupon = __webpack_require__(235);

	var _ExchangeCoupon2 = _interopRequireDefault(_ExchangeCoupon);
	...
	var routers = _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactRouter.Route, { path: 'exchangecoupon/:exchangecode', component: _ExchangeCoupon2.default })
	    )
	);
	(0, _reactDom.render)(_react2.default.createElement(
	    ...
	    { store: store },
	    routers
	), document.querySelector('#exchangecoupon'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Confirm = (function (_React$Component) {
	    ...
	    _createClass(Confirm, [{
	        ...
	        value: function close() {
	            ...
	            dispatch((0, _action.showConfirm)({ bBtn: false }));
	        }
	    }, {
	        key: 'cancel',
	        ...
	        value: function confirm(e) {
	            ...
	            var confirmData = this.props.confirmData;

	            confirmData.clickHandle(function () {
	                _this2.close();
	            });
	            e.preventDefault();
	        }
	...
	Confirm.propTypes = {
	    data: _react2.default.PropTypes.oneOfType({
...
/***/ function(module, exports) {
	...
	var changeCoupon = exports.changeCoupon = function changeCoupon(val) {
	    return { type: 'CHANGE', val: val };
	};
	var showLoading = exports.showLoading = function showLoading(val) {
	    return { type: 'LOAD', val: val };
	};
	var showConfirm = exports.showConfirm = function showConfirm(val) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dorpdown = __webpack_require__(239);

	var _Dorpdown2 = _interopRequireDefault(_Dorpdown);

	var _Coupon = __webpack_require__(244);

	var _Coupon2 = _interopRequireDefault(_Coupon);

	var _ExchangeShow = __webpack_require__(245);

	var _ExchangeShow2 = _interopRequireDefault(_ExchangeShow);
	...
	var ExchangeCoupon = (function (_React$Component) {
	    _inherits(ExchangeCoupon, _React$Component);

	    function ExchangeCoupon(props) {
	        _classCallCheck(this, ExchangeCoupon);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ExchangeCoupon).call(this, props));
	    ...
	    _createClass(ExchangeCoupon, [{
	        ...
	        value: function componentWillMount(func, elem) {
	            var _this2 = this;
	            ...
	            var serialization = function serialization(val) {
	                var re = /([0-9]{4})(?=\d)/ig;
	                return val.replace(re, '$1-');
	            };

	            var ajaxHandle = function ajaxHandle(data) {
	                data = { code: '0000', status: 0 };

	                if (data.code == '0000') {
	                    dispatch((0, _action.changeCoupon)({
	                        exchangeCode: serialization(_this2.props.params.exchangecode),
	                        status: data.status
	                    }));
	                    dispatch((0, _action.showLoading)(false));
	                    if (func && elem) {
	                        setTimeout(function () {
	                            func(elem);
	                        }, 500);
	            ...
	            _superagent2.default.get('/').end(function (data) {
	                setTimeout(function () {
	                    ajaxHandle(data);
	                }, 2000);
	            });
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                _Dorpdown2.default,
	                { callback: function callback(func, elem) {
	                        return _this3.componentWillMount(func, elem);
	                    } },
	                this.state.bBtn ? _react2.default.createElement(_Coupon2.default, { data: coupon, onChangeStore: function onChangeStore(val) {
	                        return dispatch((0, _action.changeCoupon)(val));
	                    }, toggleHandle: function toggleHandle() {
	                        return _this3.toggle();
	                    } }) : _react2.default.createElement(_ExchangeShow2.default, { data: coupon })
	            );
	        }
	    }]);
	...
	exports.default = (0, _reactRedux.connect)(init)(ExchangeCoupon);
	...
	var DorpDown = (function (_React$Component) {
	    ...
	    _createClass(DorpDown, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var transShow = function transShow(moveH) {
	            ...
	            var release = function release(elem) {
	                ...
	                if (moveH > 68) {
	                    ...
	                    _this2.props.callback(reset, elem);
	                    _this2.setState({
	                        loading: 'loading'
	                    });
	                } else {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'dorp-down', style: this.state.elemStyle },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'load' },
	                    _react2.default.createElement('span', { className: this.state.loading, style: this.state.loadStyle })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: '', ref: 'main' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Coupon = (function (_React$Component) {
	    ...
	    _createClass(Coupon, [{
	            ...
	            var successFn = function successFn(data) {
	                ...
	                if (data.code === '0000' && data.result) {
	                    ...
	                    if (data.result.status == 0 || data.result.status == -2) {
	                        _this2.props.toggleHandle();
	                        if (fn) fn();
	                    }
	                    _this2.props.onChangeStore({
	                        exchangeCode: _this2.props.data.exchangeCode,
	                        status: data.result.status
	                    });
	                }
	            };
	            _superagent2.default.get('/').end(successFn);
	        }
	    }, {
	        key: 'clickHandle',
	        value: function clickHandle(e) {
	            ...
	            dispatch((0, _action.showConfirm)({
	                bBtn: true,
	                title: '卡券兑换',
	                message: '您确定要兑换改卡劵吗？',
	                clickHandle: function clickHandle(fn) {
	                    return _this3.useCoupon(fn);
	                }
	            }));
	            e.preventDefault();
	        }
	        ...
	        value: function render() {
	                ...
	                switch (propData.status) {
	                    ...
	                    case -99:
	                        return _react2.default.createElement(
	                            'span',
	                            null,
	                            _react2.default.createElement('i', { className: 'ion-timeout' }),
	                            '网络超时,请重试'
	                        );
	                        break;
	                    //default
	            ...
	            var showClass = function showClass() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'exchange-btns' },
	                    _react2.default.createElement(
	                        'a',
	                        { type: 'submit', onClick: function onClick(e) {
	                                return _this4.clickHandle(e);
	                            }, className: showClass() },
	                        '兑换'
	                    ),
	                    _react2.default.createElement(
	                        'a',
	                        { href: 'chudao:closeActivity', className: 'btn btn-cancel' },
	                        '取消'
	                    )
	                )
	            );
	...
	exports.default = (0, _reactRedux.connect)(init)(Coupon);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ExchangeShow = (function (_React$Component) {
	    _inherits(ExchangeShow, _React$Component);

	    function ExchangeShow() {
	        _classCallCheck(this, ExchangeShow);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ExchangeShow).apply(this, arguments));
	    }

	    _createClass(ExchangeShow, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            _reactDom2.default.findDOMNode(this).addEventListener('touchmove', function (e) {
	                e.stopPropagation();
	            }, false);
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'section',
	                { className: 'coupon-exchange-success' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'show-success' },
	                    _react2.default.createElement('i', { className: showClass() }),
	                    _react2.default.createElement(
	                        'p',
	                        { className: 'font-19-333' },
	                        '卡劵',
	                        propData.exchangeCode
	                    ),
	                    showStatus()
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { className: 'btn btn-default', href: 'chuDao:closeActivity' },
	                        '确定'
	                    ),
	                    _react2.default.createElement('button', { type: 'submit', className: 'btn', style: { opacity: 0 } })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var setCoupon = function setCoupon() {
	...
	var Loading = (function (_React$Component) {
	    ...
	    _createClass(Loading, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            dispatch((0, _action.showLoading)(true));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
